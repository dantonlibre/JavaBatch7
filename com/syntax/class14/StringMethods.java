...
public class StringMethods {
	...
	System.out.println("______________________.concat()method------------------------------------");
	...
	System.out.println(country.concat(capital));//will work if both values are of String type
	int day=27;
	String month=" June ";
	...
	//System.out.println(month.concat(day)); cannot use because both values be String
